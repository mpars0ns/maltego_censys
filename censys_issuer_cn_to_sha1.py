"""
This script is written by Mark Parsons and is to be used in Maltego to lookup ssl certificate issuer common names (cn)
...
def main():
    ...
    page = 1
    query = {'query': '443.https.tls.certificate.parsed.issuer.common_name: {cn}'.format(cn=cn), 'fields':
